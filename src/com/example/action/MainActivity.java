	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//query query userQuery = new query(startDateString, duration, startTimeString,
				//endTimeString, roomId, type, number, isAvaliable);
				//以上为最终版的query
				
				Log.d("TestQuery", "running myClickHandler");
				String startDateString = "20140515";
				int duration = 3;
				String startTimeString = "0800";
				String endTimeString = "2200";
				...
				query userQuery = new query(startDateString, duration, startTimeString,
						endTimeString, roomId, type, number, isAvaliable);
				//以上为测试用的query类实例。
